 ...
 * @return  A value, representing the version.
 */
inline std::uint32_t GetHCSMemVersion_1_1_2() {
    return MAKE_VERSION(1, 1, 2);
}

/**
 * @brief   Version check for 1.1.3
 * @return  A value, representing the version.
 */
inline std::uint32_t GetHCSMemVersion_1_1_3() {
    return MAKE_VERSION(1, 1, 3);
}

/**
 * @brief   Version check for 1.1.4
 * @return  A value, representing the version.
 */
inline std::uint32_t GetHCSMemVersion_1_1_4() {
    return MAKE_VERSION(1, 1, 4);
}
